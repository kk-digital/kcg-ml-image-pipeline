...
#plot_samples_hashless_from_target_dataset(original_model, 19 ,tag_name = tag_name_x)
plot_samples_hashless_from_target_dataset(elm_model, 19 ,tag_name = tag_name_x)
