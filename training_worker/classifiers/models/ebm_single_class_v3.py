...
elm_model.load_model(minio_client = minio_client, model_dataset = "environmental",scoring_model = 'score' ,tag_name = "topic-desert", model_type = "regression-clip-h", not_include= 'batatatatatata', device= original_model.device)
