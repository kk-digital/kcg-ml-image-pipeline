...
class ClassifierFCNetwork(nn.Module):
    def __init__(self, minio_client, tag_name, input_type="input-clip", 
                 output_type="score", input_size=1280, hidden_sizes=[512, 256]):
        
        super(ClassifierFCNetwork, self).__init__()
        # set device
