...
PRIOR_MODEL_PATH = config.get_model(KandinskyConfigs.PRIOR_MODEL)
DECODER_MODEL_PATH = config.get_model(KandinskyConfigs.DECODER_MODEL)
INPAINT_DECODER_MODEL_PATH = config.get_model(KandinskyConfigs.INPAINT_DECODER_MODEL)
