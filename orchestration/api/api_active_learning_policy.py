...
@router.post("/active-learning-queue/add-new-policy", 
             status_code=200,
             response_model=StandardSuccessResponseV1[ActiveLearningPolicy],
             tags=["active learning policy"],
             description="Add a new active learning policy",
             responses=ApiResponseHandlerV1.listErrors([400,422]))
async def add_policy(request: Request, policy_data: RequestActiveLearningPolicy):
...
@router.put("/active-learning-queue/update-active-learning-policy",
            status_code=200,
            tags=["active learning policy"],
            description="Update an existing active learning policy",
            response_model=StandardSuccessResponseV1[ActiveLearningPolicy], 
            responses=ApiResponseHandlerV1.listErrors([400, 404, 422]))
async def update_policy(request: Request, policy_id: int, policy_update: RequestActiveLearningPolicy):
    api_response_handler = await ApiResponseHandlerV1.createInstance(request)
...
@router.delete("/active-learning-queue/remmove-active-learning-policy", 
