...
def parse_args():
    ...
    parser.add_argument('--substitution-batch-size', type=int, help="Batch size for the substitution model", default=1000)
...
class PromptSubstitutionGenerator:
    ...
    def choose_random_phrase(self, max_token_length):
        ...
        while(phrase_token_length > max_token_length):
            ...
            phrase_token_length=self.data_loader.get_token_length(phrase)
