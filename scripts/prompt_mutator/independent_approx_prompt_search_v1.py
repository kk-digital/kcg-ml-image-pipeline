...
def parse_args():
    ...
    parser.add_argument('--csv-phrase', help='CSV containing phrases, must have "phrase str" column', default='input/civitai_phrases_database_v6.csv')
...
class BoltzmanPromptSubstitutionGenerator:
    ...
    def rejection_sampling_by_boltzman_score(self,
        ...
        for token in range(token_number):
            ...
            substitute_energy = self.phrase_score_data[random_index].score
