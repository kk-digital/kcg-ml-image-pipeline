...
sorted_combined_images = process_and_sort_dataset_weighted_combinations(images_paths_ood,[occult_model,cybernetics_model,texture_model],[1,0,-1])

get_structure_csv_content(sorted_combined_images,"occult_minus_textureson_env_30000_sample")
...
plot_images_with_scores(selected_structure_first_52,"Top_first_52_occult_minus_textures")
plot_images_with_scores(selected_structure_second_52,"Top_second_52_52_occult_minus_textures")
plot_images_with_scores(selected_structure_third_52,"Top_third_52_occult_minus_textures")
