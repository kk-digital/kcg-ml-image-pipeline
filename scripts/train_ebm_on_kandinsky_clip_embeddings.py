...
new_combined_paths =  get_tag_jobs(34)

# Create dataloader of occult
train_loader_automated, val_loader_automated = get_clip_embeddings_by_path(new_combined_paths,1)

# Get adversarial dataset
train_loader_clip_ood, val_loader_clip_ood = get_clip_embeddings_by_tag([3,5,7,8,9,15,35,40,20,21,22],0)
...
new_mountain_model = train_model(train_loader,val_loader, adv_loader, img_shape=(1,1280),
                    batch_size=train_loader.batch_size,
                    lr=0.001,
                    beta1=0.0)
save_model_to_minio(new_mountain_model,'mountain','temp_model.safetensors')
...
# upload the graph report
minio_path="environmental/output/my_tests"
minio_path= minio_path + "/loss_tracking_per_step_1_cd_p2_regloss_mountain_training" +date_now+".png"
cmd.upload_data(minio_client, 'datasets', minio_path, buf)
# Remove the temporary file
os.remove("output/loss_tracking_per_step.png")
# Clear the current figure
...
# Load the last occult trained model
load_model_to_minio(new_aquatic_model_st,'mountain')
...
get_structure_csv_content(new_sorted_images,"mountain_on_env_30000_sample")
selected_structure_first_52 = new_sorted_images[:52]
selected_structure_second_52 = new_sorted_images[52:103]
selected_structure_third_52 = new_sorted_images[103:154]

plot_images_with_scores(selected_structure_first_52,"mountain_env_30000_tier_1")
plot_images_with_scores(selected_structure_second_52,"mountainenv_30000_tier_2")
plot_images_with_scores(selected_structure_third_52,"mountain_env_30000_tier_3")
