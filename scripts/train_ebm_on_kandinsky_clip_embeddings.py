...
def load_model_to_minio_v2(model,type, bucket_name , tag_name, value,  model_type):
        ...
        true_path  = "{}/{}/models/classifiers/{}".format('datasets',bucket_name, tag_name) #"datasets/environmental/models/classifiers/concept-cybernetic"
...
plot_samples_hashless(dataset_name = "environmental", number_of_samples = 5000,tag_name ="concept-cybernetic")
