...
with open(csv_file, mode='w', newline='', encoding='utf-8') as file:
    ...
    # Include new columns for tag_category_id and tag_category_string
    writer.writerow(['Tag ID', 'Tag String', 'Tag Category ID', 'Tag Category String', 'Image Hash', 'Image File Path', 'Prompt Generation Policy'])
    ...
    for image_tag in image_tags.find():
        ...
        # Write to CSV including the new columns
        writer.writerow([tag_def['tag_id'], tag_def['tag_string'], tag_category_id, tag_category_string, image_tag['image_hash'], image_tag['file_path'], prompt_generation_policy])
